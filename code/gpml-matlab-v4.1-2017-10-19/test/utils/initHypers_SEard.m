...
hypinit = zeros(8,1); % hypinit???????????
% Simple initialisation
% rng(3);
hyp_cov1 = abs(2*randn(1,1));
hyp_cov2 = abs(2*randn(1,1));
hyp_cov3 = abs(2*randn(1,1));
hyp_cov4 = abs(2*randn(1,1));
hyp_cov5 = abs(2*randn(1,1));
hyp_cov6 = abs(2*randn(1,1));
hyp_cov7 = abs(2*randn(1,1));
hyp_cov8 = abs(2*randn(1,1));
hyp_cov9 = abs(2*randn(1,1));
hyp_cov10 = abs(2*randn(1,1));
hyp_cov11 = abs(2*randn(1,1));
hyp_cov12 = abs(2*randn(1,1));
